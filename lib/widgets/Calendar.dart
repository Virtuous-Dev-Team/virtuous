...
class CustomCalender {
  ...
  addListToCalender(List<CalendarModel> markers,BuildContext context) {
  ...
  Widget _icon(String day, String color, String textColor,BuildContext context) => InkWell(
    onTap: (){
              ...
              builder: (context, setState) {
                return AlertDialog(
                  ...
                  title: Row(
                    ...
                    children: [
                      Icon(Icons.cancel_outlined,size: 25,color: Colours.black,)
                    ], ),
                  content:
...
Row(
  ...
  children: [
    ...
    Row(
        ...
        children: [
          Container(
            decoration: BoxDecoration(color: Colours.swatch(clrHonesty),borderRadius: BorderRadius.circular(20)),
            width: 25,height: 25,
          ),
    ...
    Text(
      ...
      style: TextStyle(
        ...
        color: Colors.black,
                        ...
                        Divider(
                          endIndent: 0,indent: 0,height: MediaQuery.of(context).size.height/30,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    decoration: BoxDecoration(color: Colours.swatch(clrFairness),borderRadius: BorderRadius.circular(20)),
                                    width: 25,height: 25,
                                  ),
                                  SizedBox(width: MediaQuery.of(context).size.width/50,),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    decoration: BoxDecoration(color: Colours.swatch(clrSelfControl),borderRadius: BorderRadius.circular(20)),
                                    width: 25,height: 25,
                                  ),
                                  SizedBox(width: MediaQuery.of(context).size.width/50,),
