...
class CustomCalender{
  Widget customCalender(BuildContext context,List<CalendarModel> markers)
  {
    ...
    return
      Container(
        decoration: BoxDecoration(color: Colours.swatch(clrBackground),borderRadius: BorderRadius.circular(10)),
      ...
      weekDayBackgroundColor: Colours.white,
       ...
       // childAspectRatio: 1.5,
        ...
        // ),
          isScrollable: true,
        leftButtonIcon: Icon(Icons.arrow_left_outlined,size: 30,color: Colors.black,),
          rightButtonIcon: Icon(Icons.arrow_right_outlined,size: 30,color: Colors.black,),
  ...
  addListToCalender(List<CalendarModel> markers)
  {
    for (int i = 0; i < markers.length; i++) {
      if (markers[i].HonestyList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].HonestyList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              title: 'Event Honesty',
              icon: _icon(
                  markers[i].HonestyList![listLength].day.toString(),clrHonesty,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].CourageList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].CourageList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              title: 'Event Courage',
              icon: _icon(
                  markers[i].CourageList![listLength].day.toString(),clrCourage,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].CompassionList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].CompassionList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].CompassionList![listLength].day.toString(),clrCompassion,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].GenerosityList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].GenerosityList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].GenerosityList![listLength].day.toString(),clrGenerosity,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].FidelityList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].FidelityList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].FidelityList![listLength].day.toString(),clrFidelity,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].IntegrityList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].IntegrityList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].IntegrityList![listLength].day.toString(),clrIntegrity,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].FairnessList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].FairnessList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].FairnessList![listLength].day.toString(),clrFairness,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].SelfControlList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].SelfControlList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].SelfControlList![listLength].day.toString(),clrSelfControl,clrBlack
              ),
            ),
          );
        }
      ...
      if (markers[i].PrudenceList!.isNotEmpty) {
        for(int listLength=0;listLength<markers[i].PrudenceList!.length;listLength++) {
          ...
          _markedDateMap.add(
            ...
            Event(
              ...
              icon: _icon(
                  markers[i].PrudenceList![listLength].day.toString(),clrPrudence,clrBlack
              ),
            ),
          );
        }
  ...
  static Widget _icon(String day,String color,String textColor) => Container(
   decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: Colours.white,),
    width: 20,
    height: 20,
  ...
  Center(
  child: Container( decoration: BoxDecoration(borderRadius: BorderRadius.circular(5),color: Colours.swatch(color),),
