...
class ResourcePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    calendarData.add(CalendarModel(CompassionList: CompassionDates,CourageList: CourageDates,FairnessList: FairnessDates,FidelityList: FidelityDates,
    GenerosityList: GenerosityDates,HonestyList: HonestyDates,IntegrityList: IntegrityDates,PrudenceList: PrudenceDates,SelfControlList: SelfControlDates
    ));
            ...
            children: [
              Container(
                ...
                child: Center(child:  Expanded(
                    ...
                    child: calendar.customCalender(context,calendarData))),
              ), 
              SfCircularChart(
